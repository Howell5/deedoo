...
flowchart LR
  ...
  plugin_dsh_base_llm_vision_sidecar["llm-vision-sidecar<br/>@deepseek-ai/dsh-llm-vision-sidecar"]
  cfg --> plugin_dsh_base_llm_vision_sidecar
...
| `llm-vision-sidecar` | `@deepseek-ai/dsh-llm-vision-sidecar` |
