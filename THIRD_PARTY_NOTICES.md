...
| [`@tanstack/react-router`](https://github.com/TanStack/router) | MIT |
| [`@tanstack/react-start`](https://github.com/TanStack/router) | MIT |
...
| [`@openai/sites-vite-plugin`](https://github.com/openai/sites) | MIT |
